...
Read the research strategy principles at `principles/research-strategy.md` (relative to workspace root). Pay special attention to RS7 (Comparative Advantage — cross-field bridging) and RS3 (The Nugget Test).
...
- Use web search to explore connections the researcher might not be aware of.
