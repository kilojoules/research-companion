...
Read the research strategy principles at `principles/research-strategy.md` (relative to workspace root).
...
**Use RS8:** Impact = skill x domain importance at this moment. Help the researcher see both sides of this equation.
